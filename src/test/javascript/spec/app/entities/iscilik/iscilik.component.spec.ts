...
import { IscilikComponent } from 'app/entities/iscilik/iscilik.component';
import { IscilikService } from 'app/entities/iscilik/iscilik.service';
import { Iscilik } from 'app/shared/model/iscilik.model';

describe('Component Tests', () => {
  describe('Iscilik Management Component', () => {
    let comp: IscilikComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IscilikComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.isciliks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
