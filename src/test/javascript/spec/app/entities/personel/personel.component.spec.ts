...
import { PersonelComponent } from 'app/entities/personel/personel.component';
...
describe('Component Tests', () => {
  describe('Personel Management Component', () => {
    let comp: PersonelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PersonelComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.personels[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
