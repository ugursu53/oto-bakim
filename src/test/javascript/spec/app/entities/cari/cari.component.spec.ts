...
import { CariComponent } from 'app/entities/cari/cari.component';
import { CariService } from 'app/entities/cari/cari.service';
import { Cari } from 'app/shared/model/cari.model';

describe('Component Tests', () => {
  describe('Cari Management Component', () => {
    let comp: CariComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CariComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.caris[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
