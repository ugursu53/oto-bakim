...
export class PersonelComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.personelService
        ...
        .subscribe(
          (res: HttpResponse<IPersonel[]>) => this.paginatePersonels(res.body, res.headers),
  ...
  trackId(index: number, item: IPersonel) {
    return item.id;
  }
  ...
  protected paginatePersonels(data: IPersonel[], headers: HttpHeaders) {
